...
class Sim2simCfg():
    ...
    class sim_config:
        mujoco_model_path = f'/home/dhanu/Dhananjay/sim2sim/resources/anybotics_anymal_c/scene.xml'
        sim_duration = 60.0
        dt = 0.005
        decimation = 4

    class robot_config:
        kps = 100.0 * np.ones(12, dtype=np.double)
    ...
    class env:
        num_actions = 12
        num_single_obs = 48
        num_history_observations = num_single_obs 
...
def run_mujoco(policy, cfg):
    ...
    default_pos = model.keyframe('standing').qpos
...
if __name__ == '__main__':
    ...
    # Load the policy
    policy = torch.jit.load('/home/dhanu/Dhananjay/sim2sim/policy/anymal_c_flat/2025-05-24_12-10-50/exported/policy.pt')
